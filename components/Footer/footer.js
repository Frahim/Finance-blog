...
export default async function Footer() {
    ...
    // Base URL to remove
    const baseUrl = 'https://financeblogs.mohammadasifhossain.site';
                            ...
                            <div id='companymenu' className="col-6  col-md-3 grid-item">
                                ...
                                <ul>
                                    {companyMenu?.menuItems.nodes.map(item => (
                                        <li key={item.id}>
                                            <Link href={`/pages/${removeBaseUrl(item.url)}`}>{item.label}</Link>
                                        </li>
                                    ))}
                                </ul>
                            </div>

                            <div className="col-6 col-xl-3 col-md-4 grid-item  mt-mb-0">
